...
private:
    ...
    void ajouterStatsEquipements();
    void creerStatistiquesCirculairesEquipements();
    void mettreAJourStatistiquesCirculairesEquipements();
